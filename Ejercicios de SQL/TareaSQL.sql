...
--Ejercicio 1 de 80
--Jordy Anderson Celestino Mendoza
--2017-0614
...
----52 - Eliminar restricciones (alter table - drop)
...
--53 - Crear y asociar reglas (create rule - sp_bindrule)
...
--54 - Eliminar y dasasociar reglas (sp_unbindrule - drop rule)
...
--55 - Valores predeterminados (create default)
...
--56 - Desasociar y eliminar valores predeterminados
